// Headsoft Suporte Modern UI - modulo remoto da versao legada.
// Este arquivo contem o corpo historico do script principal e e carregado
// pelo bootstrap minimo em `.user.js`.
...
(() => {
  ...
  const USER1_SETTINGS_API_GLOBAL = "HSHeadsoftUser1";
  ...
  const RECENT_UPDATES = Object.freeze([
    {
      ...
      mandatory: false,
      notes: [
        "Arquitetura do userscript foi dividida em bootstrap minimo local (.user.js) e modulo remoto da versao legada (.user.core.js).",
        "Arquivo principal da extensao agora fica so com a ligacao entre o modulo remoto legado e o modulo remoto user2, mantendo o .user.js como cabeca do projeto.",
        "Carregamento remoto dos dois modulos usa URL versionada para seguir o modelo de ponte/API e facilitar a publicacao no GitHub.",
      ],
    },
    {
      date: "2026-03-13",
      ...
      mandatory: false,
      notes: [
        "Release acompanha o user2 v3.01.02, que corrige a organizacao da shell da V2 para a lateral nao invadir a fila.",
        "Lista de chamados agora fica travada na coluna esquerda com largura e overflow controlados para os cards nao vazarem sob o preview.",
        "Chamado em foco ganhou coluna fixa no desktop e cai para baixo da fila apenas quando a tela realmente aperta.",
      ],
    },
    {
      date: "2026-03-13",
      ...
      mandatory: false,
      notes: [
        "Release acompanha o user2 v3.01.01, que simplifica a V2 para leitura operacional mais limpa e direta.",
        "Lista da nova versao saiu do card pesado e virou uma fila mais funcional, com foco em titulo, dono, abertura e prioridade sem excesso visual.",
        "Lateral foi resumida para contexto rapido e o preview vivo deixou de entrar ligado por padrao para nao poluir a triagem.",
      ],
    },
    {
      date: "2026-03-13",
      ...
      mandatory: false,
      notes: [
        "Release acompanha o user2 v3.01.00, que refaz a V2 como uma central operacional de chamados com command center, busca local e ordenacao por prioridade.",
        "Lista da nova versao foi reconstruida em cards profissionais com leitura de risco, ownership, cliente, idade e acao sugerida.",
        "Preview lateral e tela da requisicao agora compartilham uma linguagem visual nova, mais fluida e mais forte para uso diario.",
      ],
    },
    {
      date: "2026-03-13",
    ...
    },
    {
      ...
      mandatory: false,
      notes: [
        "O .user.js voltou a carregar o modulo remoto .user2.js via @require e passou a servir como base da versao 2.15.95.",
        ...
        "Novo .user2.js inaugura versao propria 3.00.01 com layout independente da grade, metricas e preferencias salvas separadamente da versao antiga.",
      ],
    },
    {
      date: "2026-03-13",
...
Atenciosamente.`;
  ...
  const user1Api = window[USER1_SETTINGS_API_GLOBAL] || {};
  user1Api.getUser1VersionInfo = () => ({
    version: SCRIPT_VERSION,
    source: ".user.core.js",
    page: location.pathname,
    theme: typeof getTheme === "function" ? getTheme() : "",
  });
  user1Api.bootstrapLegacyVersion = bootstrapRuntime;
  user1Api.applyExperimentalUser2Bridge = applyExperimentalUser2Bridge;
  window[USER1_SETTINGS_API_GLOBAL] = user1Api;
